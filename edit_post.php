...
if (isset($_POST['update_post'])) {
    ...
    // Handle image upload
    $imagePath = $post['image']; // default to old image
		...
		<div class="main-content" style="margin-left: 240px; padding: 40px;">
		    ...
		    <form action="" method="POST" enctype="multipart/form-data" style="max-width: 600px;">
		        <div style="margin-bottom: 15px;">
		            ...
		            <input type="text" name="title" value="<?php echo $post['title']; ?>" required class="form-input">
		        </div>

		        <div style="margin-bottom: 15px;">
		            <label>Details</label><br>
		            <textarea name="content" required class="form-input" rows="4"><?php echo $post['content']; ?></textarea>
		        </div>
		        ...
		        <div style="margin-bottom: 15px;">
		            ...
		            <div style="margin-top: 10px;">
		                <img src="<?php echo $post['image']; ?>" alt="Post Image" style="width: 200px; border-radius: 8px;">
		            </div>
		        </div>
