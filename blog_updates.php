...
if (isset($_GET['delete_post'])) {
  $delet_post_id = $_GET['delete_post'];

  $delete_item_query = mysqli_query($conn, "DELETE FROM posts WHERE id = '$delet_post_id'");
...
<head>
  ...
  <title>VWPTA - Admin Blog Posts</title>
</head>
<body>
  <!-- Header Section -->
  <div class="sidebar">
  ...
  <div class="main-content">
    ...
    <div class="add-button-container">
        <a href="add_posts.php" class="btn btn-add-product"><i class="fas fa-plus"></i> Add New Post</a>
    </div>    
    <!-- ================================================================================================== --> 
    <!-- Blog Posts Section -->   
            ...
            <?php while($row = mysqli_fetch_assoc($result)): ?>
                <div class="product-box">
                    ...
                    <div class="content">
                        ...
                        <a href="blog_updates.php?delete_post=<?= $row['id'] ?>" name="delete_post" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete this product?')">Delete</a>
                    </div>  
                </div>
            <?php endwhile; ?>
        </div>
